...
export default async function ProjectPage({ params }: PageProps) {
    const { project } = await params; // ✅ await the params
            ...
            <div className="relative w-full bg-blue-950" style={{ minWidth: '100vh' }}>
                ...
                <div className='py-20 z-10'>
                    <div className="container max-w-[800px] mx-auto px-4">
                        ...
                        <textarea className="text-gray-700 my-1 focus:outline-none p-1 rounded-lg overflow-y-hidden h-[300px] w-full" value={foundProject.description} readOnly />
