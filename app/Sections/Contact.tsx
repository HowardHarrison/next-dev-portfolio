export default function Contact() {
    return (
        <div className="" style={{ minHeight: "200px" }}>
            <div className="container mx-auto my-5 py-3">
                <div className="mx-auto text-3xl font-semibold text-center">
                    Contact me
                </div>
                <div className="mx-auto  text-center w-3/5 my-5">
                    I like to make friends with people in technology field so
                    feel free to follow my account on social media platforms.
                    Let&apos;s share our knowledge and experiences.
                </div>
                <div className="bg-gray-700 w-2/6 h-1 mx-auto my-5"></div>
                <div className=" w-2/6 mx-auto my-5 flex justify-around">
                <div className="w-8">
                        <a
